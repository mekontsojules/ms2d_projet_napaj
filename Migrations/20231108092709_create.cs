        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PdfFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VariantOfId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recipes_ProductCatalogs_ProductCatalogId",
                        column: x => x.ProductCatalogId,
                        principalTable: "ProductCatalogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Recipes_Recipes_VariantOfId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitedMesure = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierIngredientRates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierIngredientRates_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupplierIngredientRates_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchasedIngredients_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasedIngredients_PurchaseId",
                table: "PurchasedIngredients",
                column: "PurchaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recipes_ProductCatalogId",
                table: "Recipes",
                column: "ProductCatalogId");

            migrationBuilder.CreateIndex(
                name: "IX_Recipes_VariantOfId",
                table: "Recipes",
                column: "VariantOfId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierIngredientRates_IngredientId",
                table: "SupplierIngredientRates",
                column: "IngredientId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierIngredientRates_SupplierId",
                table: "SupplierIngredientRates",
                column: "SupplierId");
        }
